...
class TestFileStorageDocs(unittest.TestCase):
    ...
    def test_pep8_fs(self):
        """... the filestorage.py conforms to PEP8 Style"""
...
class TestBmFsInstances(unittest.TestCase):
    ...
    def test_all_state(self):
        """... this checks if all() function returns newly created state instance"""
    ...
    def test_to_json(self):
        """... the to_json should return serializable dict object"""
...
class TestUserFsInstances(unittest.TestCase):
    ...
    def setUp(self):
        """this initializes a new user for testing"""
    ...
    def test_count_cls(self):
        """... this checks count method with class input arg"""
        count_user = storage.count('User')
        expected = 1
        self.assertEqual(expected, count_user)

    def test_count_all(self):
        """... this checks the count method with no class input"""
        count_all = storage.count()
        expected = 2
        self.assertEqual(expected, count_all)

    def test_get_cls_id(self):
        """... this checks get method with class and id inputs"""
