#!/usr/bin/python3
"""this creates a new view for the State objects that handles
...
def amenity_by_id(amenity_id):
    """this gets an Amenity filter by id"""
