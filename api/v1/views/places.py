#!/usr/bin/python3
"""This module implements a rule that returns a view"""
...
def place_by_city(city_id):
    """A View function that returns place objects by city"""
...
def show_place(place_id):
    """The Endpoint that returns a Place object"""
...
def delete_place(place_id):
    """The Endpoint that deletes a Place object"""
    place = storage.get(Place, place_id)
    if place is None:
        abort(404)
    place.delete()
...
def insert_place(city_id):
    """The Endpoint that inserts a Place object"""
    city = storage.get(City, city_id)
    if city is None:
        abort(404)
...
def places_search():
    """this retrieves all the Place objects depending of the body of the request"""
...
def update_place(place_id):
    """The Endpoint that updates a Place object"""
    place = storage.get(Place, place_id)
    if place is None:
        abort(404)
    res = request.get_json()
