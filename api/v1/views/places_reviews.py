...
def get_review_id(review_id):
    '''
        this returns a review given its id using GET
    '''
...
def delete_review(review_id):
    '''
        this deletes a review obj given review_id
    '''
    review = storage.get("Review", review_id)
    if review is None:
        abort(404)
...
def create_review(place_id):
    '''
        this creates a new review obj through place association using POST
    '''
...
def update_review(review_id):
    '''
        this update review city object using PUT
    '''
