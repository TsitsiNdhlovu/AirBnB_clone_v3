...
class TestDBStorageDocs(unittest.TestCase):
    ...
    def tearDownClass():
        """this tidies up the tests removing storage objects"""
        storage.delete_all()
    ...
    def test_all_function_docs(self):
        """... the tests for ALL DOCS for all functions in db_storage file"""
        all_functions = TestDBStorageDocs.all_funcs
        for function in all_functions:
            self.assertIsNotNone(function[1].__doc__)

    def test_pep8_db(self):
        """... the db_storage.py conforms to PEP8 Style"""
        pep8style = pep8.StyleGuide(quiet=True)
        errors = pep8style.check_files(['models/engine/db_storage.py'])
        self.assertEqual(errors.total_errors, 0, errors.messages)

    def test_file_is_executable(self):
        """... the tests if file has correct permissions so user can execute"""
...
class TestTracebackNullError(unittest.TestCase):
    """The testing for throwing Traceback erros:
    missing attributes that Cannot be NULL"""

    @classmethod
    def setUpClass(cls):
        """this sets up the class for this round of tests"""
        print('\n\n....................................')
    ...
    def tearDown(self):
        """this tidies up tests that throw errors"""
        storage.rollback_session()

    def test_state_no_name(self):
        """... this checks to create a state with no name"""
    ...
    def test_city_no_state(self):
        """... this checks to create a city with invalid state"""
        with self.assertRaises(Exception) as context:
    ...
    def test_place_no_user(self):
        """... this checks to create a place with no city"""
        with self.assertRaises(Exception) as context:
            p = Place()
            p.save()
    ...
    def test_review_no_text(self):
        """... this checks to create a Review with no text"""
        with self.assertRaises(Exception) as context:
            r = Review()
            r.save()
    ...
    def test_amenity_no_name(self):
        """... this checks to create an amenity with no name"""
        with self.assertRaises(Exception) as context:
            a = Amenity()
            a.save()
        self.assertTrue('"Column \'name\' cannot be null"'
    ...
    def test_user_no_name(self):
        """... this checks to create a user with no email"""
        with self.assertRaises(Exception) as context:
            u = User()
            u.save()
...
class TestStateDBInstances(unittest.TestCase):
    ...
    def setUp(self):
        """this initializes new BaseModel object for testing"""
        self.state = State()
    ...
    def test_new_state(self):
        """... this checks if new() functions after instantiation and save()"""
        actual = False
...
class TestCountGet(unittest.TestCase):
    """The testing Count and Get methods"""
    ...
    def test_all_reload_save(self):
        """... this checks if all(), save(), and reload function
