...
def review_by_place(place_id):
    """The View function that returns a Review objects by Place"""
...
def show_review(review_id):
    """The Endpoint that returns a Review object"""
...
def delete_review(review_id):
    """The Endpoint that deletes a Review object"""
    review = storage.get(Review, review_id)
    if review is None:
        abort(404)
    review.delete()
...
def insert_review(place_id):
    """The Endpoint that inserts a Review object"""
    place = storage.get(Place, place_id)
    if place is None:
        abort(404)
...
def update_review(review_id):
    """The Endpoint that updates a Review object"""
    review = storage.get(Review, review_id)
    if review is None:
        abort(404)
    res = request.get_json()
